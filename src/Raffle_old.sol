...
//  * @author Pratyaksh Pal
//  * @notice This contract is for creating sample raffles
...
//         // check to see if through time has passed
...
//     ) internal override {
//         // Checks = not present (Conditionals)
...
//         // Interaction (External Contract State)
